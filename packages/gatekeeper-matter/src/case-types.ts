...
export const FORM_FIELDS: Record<string, { name: string; label: string }[]> = {
  "I-140": [
    ...
    // WP-11: the beneficiary block the client's intake fills.
    { name: "beneficiary_middle_name", label: "Beneficiary middle name" },
    { name: "city_of_birth", label: "City or town of birth" },
    { name: "alien_number", label: "Alien Registration Number" },
    { name: "ssn", label: "U.S. Social Security Number" },
    { name: "address_street", label: "Mailing address: street" },
    { name: "address_city", label: "Mailing address: city or town" },
    { name: "address_state", label: "Mailing address: state or province" },
    { name: "address_zip", label: "Mailing address: ZIP or postal code" },
    { name: "address_country", label: "Mailing address: country" },
    { name: "arrival_date", label: "Date of last arrival" },
    { name: "i94_number", label: "I-94 number" },
    { name: "current_status", label: "Current nonimmigrant status" },
    { name: "status_expires", label: "Date status expires" },
    { name: "passport_number", label: "Passport number" },
    { name: "passport_country", label: "Passport country of issuance" },
    { name: "passport_expires", label: "Passport expiration date" },
    { name: "email", label: "Email address" },
    { name: "phone", label: "Daytime telephone" },
  ],
  "G-28": [
    ...
    // WP-11: the client's contact block.
    { name: "client_address", label: "Client mailing address" },
    { name: "client_phone", label: "Client daytime telephone" },
    { name: "client_email", label: "Client email address" },
  ],
  "I-907": [
    { name: "petitioner_name", label: "Petitioner name" },
  ...
  "I-129": [
    ...
    { name: "current_status", label: "Current nonimmigrant status" },
    { name: "status_expires", label: "Date status expires" },
    { name: "address_street", label: "U.S. address: street" },
    { name: "address_city", label: "U.S. address: city or town" },
    { name: "address_state", label: "U.S. address: state" },
    { name: "address_zip", label: "U.S. address: ZIP code" },
  ],
  "I-129-O": [
